...
| CVE ID | Advisory | Severity | Type | Target | Year |
|--------|----------|----------|------|--------|------|
| [CVE-2025-10181](https://www.cve.org/CVERecord?id=CVE-2025-10181) | [GHSA-jf7w-cp2r-c3jh](https://github.com/dartiss/draft-list/security/advisories/GHSA-jf7w-cp2r-c3jh) | ![Moderate](https://img.shields.io/badge/CVSS_6.4-Moderate-orange) | ![Stored XSS](https://img.shields.io/badge/Stored_XSS-red) | WordPress Plugin: Draft List <= 2.6 | 2025 |
